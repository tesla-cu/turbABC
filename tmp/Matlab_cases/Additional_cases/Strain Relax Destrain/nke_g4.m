...
S11e=S11-(B1/B0)*lam*(-2/b)*a*(t-t2)*exp(-(t-t2)^2/b)...
        +(B2/B0)*lam^2*((4*a/b^2)*(t-t2)^2-2*a/b)*exp(-(t-t2)^2/b)...
        -(B3/B0)*lam^3*(12*a*(t-t2)/b^2-8*a*(t-t2)^3/b^3)*exp(-(t-t2)^2/b)...
        +(B4/B0)*lam^4*(16*a*(t-t2)^4/b^4-48*a*(t-t2)^2/b^3+12*a/b^2)*exp(-(t-t2)^2/b); %effective strain
