...
text(txb,tyb,'$\sigma_s \epsilon_0/k_0 = 0.4$','Interpreter','Latex','FontSize',tfont)
...
xs=2.7; %LEFT edge of legend
ys=-0.46; %TOP edge of legend
...
text(xs+(i-1)*xsp+len+xlsp,(ys-(j-1)*ysp),'$(1,\,0.4)$','Interpreter',...
    'latex','FontSize',legfont)
...
text(xs+(i-1)*xsp+len+xlsp,(ys-(j-1)*ysp),'$(2,\,0.7)$','Interpreter',...
    'latex','FontSize',legfont)
...
line([xs+(i-1)*xsp,xs+(i-1)*xsp+len],[(ys-(j-1)*ysp),(ys-(j-1)*ysp)],...
    'LineStyle','-.','Color','b','LineWidth',lwid)
text(xs+(i-1)*xsp+len+xlsp,(ys-(j-1)*ysp),'$(3,\,1.1)$','Interpreter',...
    'latex','FontSize',legfont)
...
text(txb,tyb,'$\sigma_s \epsilon_0/k_0 = 0.7$','Interpreter','Latex','FontSize',tfont)
set(gca,'FontSize',pfont,'FontName','Times')
ylabel('$\frac{\overline{S}_{11}k_0}{\epsilon_0}$','Interpreter','latex','Rotation',0,...
    'FontSize',yfontf,'Position',[xlow-(xhigh-xlow)/yxs,(ylow+yhigh)/2])
xlabel('$t\epsilon_0/k_0$','Interpreter','Latex','FontSize',xfont)
...
line([xs+(i-1)*xsp,xs+(i-1)*xsp+len],[(ys-(j-1)*ysp),(ys-(j-1)*ysp)],...
    'LineStyle','--','Color','b','LineWidth',lwid)
text(xs+(i-1)*xsp+len+xlsp,(ys-(j-1)*ysp),'$(2,\,1.8)$','Interpreter',...
    'latex','FontSize',legfont)
...
line([xs+(i-1)*xsp,xs+(i-1)*xsp+len],[(ys-(j-1)*ysp),(ys-(j-1)*ysp)],...
    'LineStyle','-.','Color','b','LineWidth',lwid)
text(xs+(i-1)*xsp+len+xlsp,(ys-(j-1)*ysp),'$(3,\,2.5)$','Interpreter',...
    'latex','FontSize',legfont)
...
text(txb,tyb,'$\sigma_s \epsilon_0/k_0 = 1.0$','Interpreter','Latex','FontSize',tfont)
set(gca,'XTick',[0,1,2,3,4])
set(gca,'FontSize',pfont,'FontName','Times')
ylabel('$\frac{\overline{S}_{11}k_0}{\epsilon_0}$','Interpreter','latex','Rotation',0,...
    'FontSize',yfontf,'Position',[xlow-(xhigh-xlow)/yxs,(ylow+yhigh)/2])
...
hold off;
text(tx,tya,'(b)','Interpreter','Latex','FontSize',tfont)
set(gca,'FontSize',pfont,'FontName','Times')
set(gca,'YTick',[-0.8,-0.6,-0.4,-0.2,0])
set(gca,'XTick',[0,1,2,3,4])
ylabel('$a_{11}$','Interpreter','latex','Rotation',0,...
...
line([xs+(i-1)*xsp,xs+(i-1)*xsp+len],[(ys-(j-1)*ysp),(ys-(j-1)*ysp)],...
    'LineStyle','-','Color','b','LineWidth',1)
text(xs+(i-1)*xsp+len+xlsp,(ys-(j-1)*ysp),'$(1,\,1.4)$','Interpreter',...
    'latex','FontSize',legfont)
...
line([xs+(i-1)*xsp,xs+(i-1)*xsp+len],[(ys-(j-1)*ysp),(ys-(j-1)*ysp)],...
    'LineStyle','--','Color','b','LineWidth',lwid)
text(xs+(i-1)*xsp+len+xlsp,(ys-(j-1)*ysp),'$(2,\,2.3)$','Interpreter',...
    'latex','FontSize',legfont)
...
line([xs+(i-1)*xsp,xs+(i-1)*xsp+len],[(ys-(j-1)*ysp),(ys-(j-1)*ysp)],...
    'LineStyle','-.','Color','b','LineWidth',lwid)
text(xs+(i-1)*xsp+len+xlsp,(ys-(j-1)*ysp),'$(3,\,3.2)$','Interpreter',...
    'latex','FontSize',legfont)
